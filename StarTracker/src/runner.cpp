...
double YAW_STEPS_PER_DEGREE = (1 / 1.8) * (30 / 120); 
double PITCH_STEPS_PER_DEGREE = (1 / 1.8) * (30 / 110);

// Hardware
AccelStepper pitchMotor(HALFSTEP, 2, 3, 4, 5);
AccelStepper yawMotor(HALFSTEP, 6, 7, 8, 9);
